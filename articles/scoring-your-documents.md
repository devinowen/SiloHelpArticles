...
> Scoring your resumes and cover letters helps you perfect each document. Get customized feedback on ways to improve your resume based on best practices from industry experts.
...
2. Click `Edit` on the resume card that you want to score.
3. Click `Score Your Resume`.
4. A popup will appear when we've scored your resume with an overall score and suggestions for improvements.
